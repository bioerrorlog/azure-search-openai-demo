    ...
    def run(self, q: str, overrides: dict) -> any:
        ...
        completion = openai.ChatCompletion.create(
            ...
            messages=[
                ...
                {"role": "user", "content": self.user_oneshot},
                {"role": "assistant", "content": self.answer_oneshot},
        ...
        return {"data_points": results, "answer": completion.choices[0].message.content, "thoughts": f"Question:<br>{q}<br><br>Prompt:<br>" + prompt.replace('\n', '<br>')}
